...
export const AboutMe = () => {
  return (
    <>
      <article className="flex flex-wrap-reverse max-w-screen-xl m-auto justify-center items-center gap-10 lg:gap-32 md:py-8 text-lg text-center xl:text-left xl:flex-nowrap xl:justify-between">
        ...
        <div className="relative w-96 lg:w-125">
          <Image
      ...
      <article>
        ...
        <div className="flex flex-wrap items-center justify-center gap-16 py-16">
          <Project
            name="Top Films"
