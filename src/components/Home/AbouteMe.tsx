  ...
  return (
    <main className="flex flex-wrap-reverse max-w-screen-xl m-auto justify-center items-center gap-10 md:gap-32 md:py-8 text-lg text-center xl:text-left xl:flex-nowrap xl:justify-between">
      <div className="flex flex-col items-center xl:items-start gap-4 w-full xl:w-120">
        ...
        <ul className="flex flex-wrap justify-center xl:grid xl:grid-cols-2 xl-w-fit gap-3 text-md">
          <li className="w-fit py-2 rounded-md flex justify-center items-center gap-2">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
            ...
            <a target='_blank' href="https://www.linkedin.com/in/giovane98sp/">LinkedIn</a>
          </li>
          <li className="w-fit py-2 rounded-md flex justify-start items-center gap-2">
            ...
            <a target='_blank' href="https://github.com/gio98sp">GitHub</a>
          </li>
          <li className="w-fit py-2 rounded-md flex justify-center items-center gap-2">
            <svg
              stroke="currentColor"
            ...
            <a target='_blank' href="https://www.facebook.com/profile.php?id=100040316592013">Facebook</a>
          </li>
          <li className="w-fit py-2 rounded-md flex justify-center items-center gap-2">
            <svg
              stroke="currentColor"
            ...
            <a target='_blank' href="https://www.instagram.com/giovane98sp/">Instagram</a>
          </li>
          <li className="w-fit py-2 rounded-md flex justify-center items-center gap-2">
            <svg
              stroke="currentColor"
            ...
            <a href="">giovane98sp@gmail.com</a>
          </li>
        </ul>
      </div>
      <div className="relative">
        ...
        />
        <p className='p-1 md:p-4 w-fit text-base leading-tight bg-gray-500 rounded-xl absolute -bottom-[0.75rem] sm:bottom-3'>
          <span className='text-xl md:text-4xl text-gio-300'>1+</span>
          <br />
          ano de experiência
        </p>
      </div>
